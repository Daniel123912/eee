...
export default function Maincontainer({auth}) {
  return (
  ...
  <section
    ...
    style={{ backgroundImage: 'url(storage/upload/bg-pattern.png)' }}
  >
    <div className="container">
      <div className="row">
  ...
  <section
    ...
    style={{ backgroundImage: 'url(storage/upload/bg-facts.jpg)' }}
  >
    <div className="container">
      <h2>
